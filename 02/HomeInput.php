...
<table class="type05">
  ...
  <tr><th>性別</th><td><input type="radio" name="sex" value="0"　required placeholder="マサラタウン"> 男性<input type="radio" name="sex" value="1"> 女性<input type="radio" name="sex" value="2" checked> どちらでもない</td></tr>
  <tr><th>住所</th><td><input type="textbox" name="address"required placeholder="マサラタウン"></p></td></tr>
  <tr><th>電話番号</th><td><input type="textbox" size="4" name="tel" required>-<input type="textbox" size="4" name="tel2" required>-<input type="textbox" size="4" name="tel3" required></td></tr>
  <tr><th>メールアドレス</th><td><input type="textbox" name="mail1" required>@<input type="textbox" name="mail2" required></td></tr>
  ...
  <tr><th>質問内容</th><td><textarea name="comment" cols="50" rows="5"required placeholder="敵の攻撃をかわすことが出来ません。"></textarea></td></tr>
</table>
