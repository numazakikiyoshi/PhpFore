...
<table class="type05">
  ...
  <tr><th>性別</th><td><input type="radio" name="sex" value="男性"> 男性
                    　　<input type="radio" name="sex" value="女性"> 女性
                    　　<input type="radio" name="sex" value="どちらでもない" checked> どちらでもない</td></tr>
  <tr><th>住所</th><td><input type="textbox" name="address"required placeholder="マサラタウン"></p></td></tr>
  <tr><th>電話番号</th><td><input type="textbox" pattern="^[0-9]{2,4}" size="4" name="tel" required placeholder="025">-
                          <input type="textbox" pattern="^[0-9]{2,4}" size="4" name="tel2" required placeholder="025">-
                          <input type="textbox" pattern="^[0-9]{2,4}" size="4" name="tel3" required placeholder="025"></td></tr>
  <tr><th>メールアドレス</th><td><input type="textbox"  name="mail1" required placeholder="MasterPoke">@
                              <input type="textbox"  name="mail2" required placeholder="kanto.co"></td></tr>
  <tr><th>どこで知ったか<br>（複数回答可）</td><td><input type="checkbox" name="where[]" value="あっちの方">あっちの方
